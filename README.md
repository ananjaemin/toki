...
| **Oh My Pi (OMP)** | `~/.omp/agent/sessions/**/*.jsonl` plus profile and XDG stores | Reads pi-family JSONL sessions as a distinct OMP source with model, cost, project, and session attribution. |
